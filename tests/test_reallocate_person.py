...
class TestReallocatePerson(unittest.TestCase):
    ...
    def test_prompt_returned_reallocate_staff_to_livingspace(self):
    ...
    def test_if_staff_is_not_reallocated_to_living_space(self):
    ...
    def test_if_fellow_is_reallocted(self):
    ...
    def test_if_staff_is_reallocted(self):
    ...
    def test_if_person_is_not_reallocted_if_all_rooms_are_full(self):
    ...
    def test_room_to_be_reallocated_person_is_occupant(self):
